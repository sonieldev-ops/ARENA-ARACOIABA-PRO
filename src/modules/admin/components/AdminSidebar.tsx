...
const menuItems = [
  ...
  { label: 'Arbitragem', icon: ShieldCheck, href: '/admin/arbitros' },
  { label: 'Controle Ao Vivo', icon: Activity, href: '/admin/controle-ao-vivo' },
  ...
  { label: 'Governança', icon: ShieldCheck, href: '/admin/governanca' },
